...
-- Indica a Alex que usará el modo básico de análisis.
-- Este modo produce una función 'alexScanTokens :: String -> [Token]'
-- que transforma una cadena en una lista de tokens.
%wrapper "basic"
